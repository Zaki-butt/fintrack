...
<div class="h-16 bg-white border-b border-gray-200 fixed top-0 right-0 left-64 z-10">
  <div class="h-full px-6 flex items-center justify-between">
    ...
    <div class="flex-1 max-w-xl">
      <div class="relative">
        <!-- Search Icon -->
        <svg class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="relative group">
        <button
          ...
          <div class="text-left">
            <p class="text-gray-900 text-sm">John Doe</p>
        ...
        <div
          ...
          <hr>
          <a href="#" class="block px-3 py-2 hover:bg-gray-100 rounded-md">Profile</a>
          <a href="#" class="block px-3 py-2 hover:bg-gray-100 rounded-md">Settings</a>
          <a href="#" class="block px-3 py-2 hover:bg-gray-100 rounded-md">Billing</a>
          <hr>
          <a href="#" class="block px-3 py-2 hover:bg-gray-100 rounded-md">Log out</a>
        </div>
      </div>
