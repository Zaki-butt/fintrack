    ...
    <nav class="px-4 space-y-1">
       ...
       {{ request()->routeIs('dashboard') ? 'bg-[#3B82F6] text-white' : 'text-gray-600 hover:bg-gray-50' }}">
        ...
        @role('user')
            ...
            {{ request()->routeIs('income.*') ? 'bg-[#3B82F6] text-white' : 'text-gray-600 hover:bg-gray-50' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('expenses.index') }}"
                class="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors 
            {{ request()->routeIs('expenses.*') ? 'bg-[#3B82F6] text-white' : 'text-gray-600 hover:bg-gray-50' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
